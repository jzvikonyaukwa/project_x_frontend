...
const config = {
  ...
  safelist: [
    {
      pattern: /bg-(blue|green|indigo|pink|orange|rose|slate|gray|zinc|neutral|stone|red|amber|yellow|lime|emerald|teal|cyan|sky|violet|purple|fuchsia)-(50|100|200|300|400|500|600|700|800|900|950)/,
    },
    {
      pattern: /border-(blue|green|indigo|pink|orange|rose|slate|gray|zinc|neutral|stone|red|amber|yellow|lime|emerald|teal|cyan|sky|violet|purple|fuchsia)-(50|100|200|300|400|500|600|700|800|900|950)/,
    },
    'text-axe-dark-blue'
  ],
  important: true,
